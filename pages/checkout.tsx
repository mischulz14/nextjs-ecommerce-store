  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="checkout page with inputs" />
      </Head>
      <div>
        <div className="mx-auto dark:text-white dark:bg-slate-600">
          ...
          >
            ...
            <button
              ...
              className="checkout-confirm-order mx-auto mb-6 scale-110 btn-primary bg-slate-900 hover:scale-125"
            >
              Confirm Order
            </button>
          </form>
